...
import { useBankDetails } from "@/hooks/kesy/useDeposit";
            ...
            <div className="w-full">
              <div className="">
                ...
                <p className="text-sm font-funnel-display text-muted-foreground max-w-md">
                  Paste the following details into your bank transfer. Include
                  the reference in your memo or the transfer might be delayed.
                </p>
              </div>
            </div>
